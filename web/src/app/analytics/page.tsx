          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            {isLoading || !scope ? (
              ...
              <>
                ...
                <Kpi label={t("analytics.fees")} value={fmtUsd(usd(scope.feesUsdc))} sub={win === "all" && data ? `${t("analytics.creatorPaid")} ${fmtUsd(usd(data.allTime.feesCreatorUsdc))} · ${t("analytics.buyback")} ${fmtUsd(usd(data.allTime.buybackUsdc))}` : undefined} tone="gold" />
              </>
            )}
          </div>
